<template>
    <div>
        <selfModel
            :visible="visible"
            width="915"
            :title="tableTitle?tableTitle:'上传结果'"
            background="#F8F9FC"
            @close="closeModel"
        >
            <div  slot="modelContent" class="guihuanModel">
                ...
                >
                    ...
                    <el-table-column prop="CompactNo" align="center" label="合约编号"  width="160" show-overflow-tooltip></el-table-column>
                    ...
                    <el-table-column prop="resultMsg" align="center" label="展期结果" width="150" show-overflow-tooltip></el-table-column>
                </el-table>
                </template> -->
