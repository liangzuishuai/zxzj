    ...
    <div>
                    ...
                    <el-form ref="form" :model="form">
                        ...
                        <div class="flex">
                            <div class="left el-form--inline">
                                <el-form-item :label="form.attribute==1?'证券代码':'篮子代码'" v-if="form.attribute!=0">
                                ...
                                <el-form-item label="合约到期日期起">
                                    <el-date-picker
                                        ...
                                        size="small"
                                        style="width: 180px"
                                        placeholder="选择合约到期日期">
                                        
                                    </el-date-picker>
                                </el-form-item>
                                <el-form-item label="合约到期日止">
                                    <el-date-picker
        ...
        <div class="bgfff">
            ...
            <el-table 
                ...
                <el-table-column prop="AppNo" align="center" label="原合约编号" width="240"></el-table-column>
            </el-table>
            <!-- //导出用的table -->
            <el-table 
                id="tableExport"
                ...
                <el-table-column prop="CompactNo" align="center" label="合约编号" width="120" show-overflow-tooltip></el-table-column>
                <el-table-column prop="BusiCode" align="center" label="约定模式" width="90">
                    <template slot-scope="scope">  
                        {{dictionary.BusiCodeDic[scope.row.BusiCode]}}
                    </template>
                ...
                <el-table-column prop="PostFee1" align="center" label="预计违约金" width="100"></el-table-column>
                <el-table-column prop="FundAccount" align="center" label="资金账号" width="110"></el-table-column>
                <el-table-column prop="AppNo" align="center" label="原合约编号" width="110"></el-table-column>
            </el-table>
    ...
    methods: {
        ...
        showDetail(record){
            ...
            this.detailData = {
                ...
                "年融资利率(融券费率)": utils.percent2(record.FeeRate),
                "提前归还利率(费率)": utils.percent2(record.PreRate),
                年违约金率: utils.percent2(record.PostRate),
