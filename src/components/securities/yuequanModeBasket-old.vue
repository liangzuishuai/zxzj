...
export default {
    ...
    methods: {
        ...
        add: function () {
            ...
            this.form.CustRate = util.Add(parseFloat(this.form.CustRate), 0.50);
        },
        min: function () {
            let { CustRate, FeeRate } = this.form
            console.log('CustRate', CustRate)
            FeeRate = FeeRate || '0'
        ...
        //         return;
        //     }
        //     this.form.CustRate  = util.Minus(parseFloat(this.form.CustRate), 0.50);
        //     if (this.form.CustRate <= this.editData.FeeRate) {
        //         this.form.CustRate = parseFloat(this.editData.FeeRate);
        //     }
        // },
    }   
}
